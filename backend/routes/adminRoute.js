...
import { addCategory, loadAllCategory, toggleCategoryStatus, updateCategory } from '../controllers/categoryController.js'
...
adminRouter.post('/edit-category/:id', adminAuth, updateCategory)
